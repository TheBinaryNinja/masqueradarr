...
The TVApp2 docker image is built on Debian (bookworm-slim) and includes the `📦 bash` package. Use one of the following to access the shell for this container:
