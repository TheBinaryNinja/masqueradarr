...
const props = defineProps<{ label: string; icon: string; iconColor?: string; defaultValue?: string; modelValue?: string; mono?: boolean; readonly?: boolean; placeholder?: string }>();
...
<template>
  <div class="endpoint-field">
    ...
    <div :class="['input', { mono }]" :style="{ flex: 1, fontSize: mono ? '12px' : 'var(--fs-base)' }">
      ...
      <input v-model="val" :readonly="readonly" :placeholder="placeholder" />
    </div>
