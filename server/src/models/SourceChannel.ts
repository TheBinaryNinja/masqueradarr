...
// SourceChannel — the pristine, normalized channel REFERENCE store, adopted verbatim from d-combine's
...
// re-imports/syncs upsert idempotently. It is seed-only: NOT surfaced to the UI. At seed/sync time it is
// projected ONCE into the editable PlaylistChannel store (sources/toPlaylistChannel.ts), which is the 1:1
// UI-facing channel collection; a Restore Defaults rebuilds PlaylistChannel from this reference.
